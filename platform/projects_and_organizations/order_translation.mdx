...
Once you send the order, an agency task is created for each language.
...
The agency will receive an email overview of the tasks (number of keys, words and characters).

They'll also receive your email address and contact you with a price estimate.
